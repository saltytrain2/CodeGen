...
def _build_io_outint() -> TacFunc:
    ...
    tacfunc.append(TacStore(TacStr("%d"), tacregs[6], 3))
    tacfunc.append(TacStore(tacregs[6], tacregs[4]))

    # time to print to screen
    tacfunc.append(TacLoad(tacregs[4], tacregs[7], 3))
    tacfunc.append(TacLoad(tacregs[3], tacregs[8], 3))
    tacfunc.append(TacCall("printf@PLT", [tacregs[7], tacregs[8]], tacregs[9]))
